...
[ExerciseTestFixture("dotNet2", "2-Linq", "LinqExamples", @"LinqExamples\JoinExamples.cs")]
public class JoinExamplesTests
{
    ...
    [MonitoredTest] public void GetEvenNumbersOfIntersection_ShouldReturnEvenNumbersThatAreInBothLists()
    {
        //Arrange
